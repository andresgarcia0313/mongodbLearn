...
use("Restaurante")
// Insertar un documento en la colección 'restaurants'
...
// Consultar un documento con campos específicos en la colección 'restaurants'
db.restaurants.findOne({}, { _id: 0, name: 1, cuisine: 1 })
use("Restaurante")
// Consultar un documento específico en la colección 'restaurants'
db.restaurants.findOne()
use("Restaurante")
db.restaurants.stats()
db.restaurants.stats().size
